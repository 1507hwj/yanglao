<template>
  <div>
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="price" label="商品促销价格"></el-table-column>
      <el-table-column prop="price" label="商品原始价格"></el-table-column>
      <el-table-column prop="kitchenInfo" label="商品厨卫信息"></el-table-column>
